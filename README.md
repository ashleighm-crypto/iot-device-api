...
This is an application for beginners who want to learn how to build a backend application consisting of multiple microservices with [Flask](https://flask.palletsprojects.com/). In this application, you will create an application consisting of two backend components: 
...
## Want to know more?
If you have questions about the application or the tasks, or if you find any errors, feel free to ask questions and participate in discussions within the repository [issues](https://github.com/jetbrains-academy/flask-app-course/issues).
