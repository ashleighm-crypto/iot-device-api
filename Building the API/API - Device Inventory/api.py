...
class DeviceSchema(Schema):
    ...
    def validate_required_fields(self, data, original_data, **kwargs):
        ...
        # TODO: check if the method is POST, iterate over required fields, if any of them are absent in the provided
        #  data, raise ValidationError with a custom message indicating which filed is missing.
